 ...
 */
export const DomainLocationModuleEvents: any = {
 ...
 */
export class DomainLocationModule extends AbstractDomainModule {
   ...
   * @private
   */
  private getIpFromDomain(domain: string): Promise<string> {
