...
exports.W3C2Module = exports.W3cValidatorModuleEvents = void 0;
...
class W3C2Module extends AbstractPuppeteerJourneyModule_1.AbstractPuppeteerJourneyModule {
    ...
    init(config, context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Install w3c store.
            (_a = this.config.storage) === null || _a === void 0 ? void 0 : _a.installStore('w3c_validator_2', this.context, {
                url: 'Url',
                type: 'Type',
                message: 'Message',
                extract: 'Extract',
            ...
            if (this.dom) {
                try {
                    ...
                    result.messages
                        ...
                        (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.storage) === null || _b === void 0 ? void 0 : _b.add('w3c_validator_2', this.context, item);
                    });
                    success = true;
                }
                catch (error) {
    ...
    initEvents(journey) {
        ...
        journey.on(AbstractPuppeteerJourney_1.PuppeteerJourneyEvents.JOURNEY_CLOSE, (data) => __awaiter(this, void 0, void 0, function* () {
